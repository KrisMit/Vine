...
import DetailsCardVideo from '../Details/DetailsCardVideo';
import PassportDescription from '../Profile/PassportDescription';
...
const Details = ({ nft }) => {
  console.log({ nft });
  if (!nft || !nft.tokenAttributes || !nft.lic_agr) return <div> Loading </div>;
  else
    return (
      <VineLayout>
              ...
              >
                ...
                <CardContent>
                  <Grid
                    ...
                    justify="center"
                  >
                    {nft.tokenAttributes.length > 0 ? (
                      <>
                        {nft.tokenAttributes.map(item => {
                  ...
                  >
                    ...
                    <Grid item xs={6}>
                      <Typography component="div" sx={styles.text} marginRight={{ xs: 0, md: 2 }}>
                        <Link href={nft.external_url} underline="none">
                          DVLPNFT
                        </Link>
                      </Typography>
                    </Grid>
                ...
                >
                  ...
                  <Link
                    ...
                    underline="none"
                    /* href={`https://testnets.opensea.io/assets/${nft.contractAddress}/${nft.tokenId}`} */
